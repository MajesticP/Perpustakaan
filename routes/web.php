...
Route::middleware('auth', 'user-access:anggota')->name('anggota.')->group(function () {
  Route::resource('/anggota/peminjaman', \App\Http\Controllers\BarangController::class);
  Route::resource('/anggota/sanksi', \App\Http\Controllers\KomputerController::class);
