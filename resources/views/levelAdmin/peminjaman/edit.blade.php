        ...
        <form action="{{ route('admin.peminjaman.update', $peminjaman->id_peminjaman) }}" method="POST"  >
          ...
          <div class="form-group">
            ...
            <select class="form-control" name="no_buku" id="exampleFormControlSelect1">
              <option value="{{ old('a', $peminjaman->no_buku)}}">{{ old('a', $peminjaman->no_buku)}}</option>
              @foreach ($buku as $cus)
          ...
          <div class="form-group">
            ...
            <select class="form-control" name="id_anggota" id="exampleFormControlSelect1">
              <option value="{{ old('a', $peminjaman->id_anggota)}}">{{ old('a', $peminjaman->id_anggota)}}</option>
            ...
            <div class="form-group">
                ...
                <input type="date" name="tgl_peminjaman" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter tgl" value="{{ old('a', $peminjaman->tgl_peminjaman)}}">
            ...
            <div class="form-group">
              ...
              <input type="date" name="tgl_pengembalian" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter tgl" value="{{ old('a', $peminjaman->tgl_pengembalian)}}">
              <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>
            ...
            <div class="form-group">
              ...
              <select class="form-control" name="status" id="exampleFormControlSelect1">
                <option value="{{ old('a', $peminjaman->status)}}">{{ old('a', $peminjaman->status)}}</option>
